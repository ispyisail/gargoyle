...
<%
	...
	gargoyle_header_footer -h -s "connection" -p "wireguard" -j "wireguard.js table.js wg_client_config.js" -z "wireguard.js" -i wireguard_gargoyle network firewall ddns_gargoyle
%>
