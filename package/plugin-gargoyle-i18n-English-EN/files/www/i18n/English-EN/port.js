...
prtS.NoMiniupnpdErr="You need to install an additional package to use this option!";
prtS.POISect="Individual Port Opening";
prtS.OpeIPort="Open Individual Ports From WAN to LAN";
prtS.PORSect="Port Range Opening";
prtS.OpeRPort="Open Port Range From WAN to LAN";
...
prtS.UpOErr="Could not update open port.";

//edit.sh pages
prtS.PESect="Edit Port Forward";
prtS.POESect="Edit Open Port";
