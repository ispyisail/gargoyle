...
<%
	...
	gargoyle_header_footer -h -s "system" -p "qr_code" -c "qr_code.css" -j "wg_client_config.js drawdown.js qrcodegen.js optgroup.js qr_code_common.js qr_code.js" -z "qr_code.js" -i gargoyle system dhcp uhttpd firewall network wireless wireguard_gargoyle mjpg-streamer qr_code_gargoyle
%>
